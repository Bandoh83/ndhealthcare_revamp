...
export default function Pricing({
  ...
  return (
    <div className={`cs_pricing_card_container ${popular ? 'cs_popular_card' : ''}`}>
      ...
      {/* Title */}
      <h3 className="cs_heading_color cs_fs_28 cs_semibold mb-3">
        {title}
      </h3>

      {/* Subtitle */}
      {subTitle && (
        <p className="cs_gray_color cs_fs_16 mb-4 lh-base">
          {subTitle}
        </p>
      )}
      ...
      <div className="cs_price_section mb-4">
        <h2 className="cs_orange_color cs_fs_48 cs_bold mb-0">
          {price}
        </h2>
      ...
      <div className="cs_features_list mb-4">
        <ul className="list-unstyled cs_fs_16 cs_heading_color">
          {featureList?.map((item, index) => (
            <li key={index} className="d-flex align-items-center mb-3 text-start">
